...
import { FreezeCompanyDialog } from "@/components/admin_components/freeze-company-dialog"; // ✅ 1. ADD IMPORT
  ...
  return (
    <div className="max-w-7xl mx-auto pb-20">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <CompanyModal categories={categories} />
      </div>
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex justify-end gap-2">
                        ...
                        <CompanyModal categories={categories} company={company} />
