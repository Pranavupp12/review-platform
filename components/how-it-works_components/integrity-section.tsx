      ...
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="mb-12 max-w-2xl">
          ...
          <p className="text-lg text-gray-500 mt-4">
            We built this platform on a simple foundation: money cannot buy trust. Here is how we keep the playing field level.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(200px,auto)]">
          ...
          <div className="group md:col-span-2 bg-[#0892A5] rounded-3xl p-8 shadow-sm hover:shadow-lg  transition-all duration-300 relative overflow-hidden">
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
              ...
              <div>
                <h3 className="text-xl font-bold text-white mb-3">No Pay-to-Remove</h3>
                <p className="text-white/90 text-md leading-relaxed max-w-md font-medium">
                  Companies cannot pay us to delete negative reviews or hide feedback. 
                  It doesn't matter if they use our free tools or paid services—their reputation is earned, not bought.
                </p>
              </div>
            </div>
          </div>

          {/* Card 2: Open Access (Small) - COLOR #0ABED6 */}
          <div className="bg-[#0ABED6] rounded-3xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 flex flex-col justify-between relative overflow-hidden">
            ...
            <div>
              <h3 className="text-xl font-bold text-white mb-2">Open to Everyone</h3>
              <p className="text-white/90 text-sm font-medium leading-relaxed">
                You don't need an invitation code to speak up. If you had an experience, you have a voice here.
              </p>
            </div>
          </div>

          {/* Card 3: Privacy First (Small) - COLOR #0ABED6 */}
          <div className="bg-[#0ABED6] rounded-3xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 flex flex-col justify-between relative overflow-hidden">
            ...
            <div>
              <h3 className="text-xl font-bold text-white mb-2">Reviewer Privacy</h3>
              <p className="text-white/90 text-sm font-medium leading-relaxed">
                We protect your personal data. Companies can reply to you, but they can't access your private details.
              </p>
            </div>
          </div>

          {/* Card 4: Uncensored (Large) - COLOR #0892A5 */}
          <div className="md:col-span-2 bg-[#0892A5] rounded-3xl p-8 shadow-sm hover:shadow-lg  transition-all duration-300 relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-8 h-full">
              ...
              <div>
                <h3 className="text-xl font-bold text-white mb-3">Uncensored Feedback</h3>
                <p className="text-white/90 text-md leading-relaxed font-medium max-w-xl">
                  We don't moderate for sentiment. Whether a review is a 1-star complaint or a 5-star praise, 
                  it stays up as long as it follows our content guidelines.
                </p>
              </div>
            </div>
          </div>
