  ...
  const ValueCard = ({ value }: { value: any }) => (
    <div className="flex flex-col items-center text-center space-y-4 px-4 group">
      ...
      <h3 className="text-xl font-bold text-gray-900">
        {/* ✅ Translate Title */}
        <TranslatableText text={value.title} />
      </h3>
      
      <div className="text-gray-600 leading-relaxed max-w-xs mx-auto">
        {/* ✅ Translate Description */}
        <TranslatableText text={value.description} />
      </div>
    </div>
  );
      ...
      <div className="container mx-auto max-w-7xl px-4 text-center">
        ...
        <div className="mb-10">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 tracking-tight mb-6">
            <TranslatableText text="The Principles That Guide Us" />
          </h2>
          <div className="text-lg text-gray-600 leading-relaxed max-w-3xl mx-auto">
            <TranslatableText text="Our goal to become the definitive standard of trust is bold. To realize this, we must embody openness and clarity in all our actions. We rely on these shared principles to direct our behavior." />
          </div>
        </div>
