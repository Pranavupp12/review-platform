       ...
       {/* Left: Text Content */}
        <div className="space-y-8 max-w-3xl">
          <h2 className="text-2xl md:text-3xl font-bold text-black leading-tight">
            Help Data Solutions, <br/>
            powered by <span className="text-[#0892A5]">InsightLayer</span>
          </h2>
          
          <p className="text-lg text-gray-700 font-medium leading-relaxed">
            Embed rich consumer sentiment and trust signals into every strategic business decision.
          </p>
          
          <div className="space-y-4">
            <p className="text-md text-gray-500 leading-relaxed">
              Our intelligence layer goes beyond surface-level metrics. We help you understand the <strong>"Why"</strong> behind customer behavior, not just the "What".
            </p>
          ...
          <p className="text-gray-500 italic border-l-4 border-[#0ABED6] pl-4 py-1">
            "Data without context is just noise. InsightLayer turns that noise into a clear signal for growth."
          </p>

        </div>

        {/* Right: Graphic (Replaced with Image) */}
        <div className="relative">
           {/* Image Container styling to match the previous card look */}
           <div className=" p-3 relative z-10 overflow-hidden h-[450px] lg:h-[600px]">
              <div className="relative w-full h-full rounded-2xl overflow-hidden bg-gray-50">
                <Image
                  // TODO: Replace with your actual image path, e.g., "/images/trust-data-dashboard.png"
           ...
           {/* Background Glow (Kept for consistency) */}
