// components/home_components/business-cta.tsx
...
export function BusinessCTA() {
  return (
    <section > {/* Use a subtle background color */}
      <div className="container mx-auto max-w-7xl px-4">
        <div className="relative bg-[#0ABED6] rounded-lg p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 overflow-hidden">
          ...
          {/* Background pattern (mimicking the screenshot) */}
          <div className="absolute inset-0 ">
            {/* You can use a more sophisticated SVG pattern here, for now, simple shapes */}
          ...
          <div className="relative z-10 text-center md:text-left max-w-lg">
            ...
            <p className="text-white text-base md:text-lg">
              Strengthen your reputation with reviews on Help.
            </p>
          </div>
